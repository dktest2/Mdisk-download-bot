...
def echo(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    if not checkuser(message):
        app.send_message(message.chat.id, '__You are either not **Authorized** or **Banned**__',reply_to_message_id=message.id,reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🔥 ᴊᴏɪɴ ᴄʜᴀɴɴʟ 🔥", url="https://t.me/movie_a1")]]))
        return
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🔥 ᴊᴏɪɴ ᴄʜᴀɴɴʟ 🔥", url="https://t.me/movie_a1")]]))
